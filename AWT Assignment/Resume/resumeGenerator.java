...
//            String fileName = details.get("Name");

            PdfWriter.getInstance(resume, new FileOutputStream(details.get("Name")+"-CV"+".pdf"));
            resume.open();
            LineSeparator line;
            line = new LineSeparator();
            resume.add(Chunk.NEWLINE);
            Font font2 = new Font(Font.FontFamily.HELVETICA, 16, Font.BOLD );
            Paragraph name = new Paragraph(details.get("Name"), font2);
            name.setAlignment(Paragraph.ALIGN_RIGHT);
            resume.add(name);

            Font font = new Font(Font.FontFamily.HELVETICA, 8);

            Paragraph address = new Paragraph(details.get("Address"), font);
            address.setAlignment(Paragraph.ALIGN_RIGHT);
            resume.add(address);
            Paragraph contact = new Paragraph(details.get("ContactNumber"), font);
            contact.setAlignment(Paragraph.ALIGN_RIGHT);
            resume.add(contact);
            Paragraph email = new Paragraph(details.get("Email"), font);
            ...
            Paragraph colp = new Paragraph(20, details.get("College"),font1);
            ...
            Paragraph sc2 = new Paragraph(20, details.get("SchoolX"),font1);
        ...
        File file = new File(details.get("Name")+"-CV"+".pdf");
